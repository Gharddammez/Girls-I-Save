							...
							<!-- block -->
		                        <div class="block">
									...
									<a href="content.php"><i class="icon-arrow-left"></i> Back</a>
									   <?php
                                       $query = mysqli_query($conn, "select * from content where content_id = '$get_id'") or exit(mysqli_error());
...
?>
									   ...
									   <form class="form-horizontal" method="POST">
										...
										<div class="controls">
												<textarea name="content" id="GuavyTech_full">
 ...
 if (isset($_POST['update'])) {
     ...
     mysqli_query($conn, "update content set title = '$title' , content = '$content' where content_id = '$get_id'") or exit(mysqli_error());
     ?>
										<script>
