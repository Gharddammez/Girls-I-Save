						...
						<div class="span9" id="content">
		                    <div class="row-fluid">
		                        ...
		                        <div id="" class="block">
									...
									<?php
                                    $query = mysqli_query($conn, "select * from subject where subject_id = '$get_id'") or exit(mysqli_error());
...
?>
										...
										<div class="control-group">
											...
											<div class="controls">
													<textarea name="description" id="GuavyTech_full">
    ...
    if (isset($_POST['update'])) {
        ...
        mysqli_query($conn, "update subject set subject_code = '$subject_code' ,
																		...
																		where subject_id = '$get_id' ") or exit(mysqli_error());

        mysqli_query($conn, "insert into activity_log (date,username,action) values(NOW(),'$user_username','Edit Subject $subject_code')") or exit(mysqli_error());
