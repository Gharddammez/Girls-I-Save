                ...
                <div class="span5" id="content">
                     <div class="row-fluid">
					  <!-- breadcrumb -->
										...
										where teacher_class_id = '$get_id'") or exit(mysqli_error());
...
?>
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<form method="post">
								<textarea name="content" id="GuavyTech_full"></textarea>
								<br>
								...
								<?php
                                    if (isset($_POST['post'])) {
                                        ...
                                        mysqli_query($conn, "insert into teacher_class_announcements (teacher_class_id,teacher_id,content,date) values('$get_id','$session_id','$content',NOW())") or exit(mysqli_error());
                                        mysqli_query($conn, "insert into notification (teacher_class_id,notification,date_of_notification,link) value('$get_id','Add Annoucements',NOW(),'announcements_student.php')") or exit(mysqli_error());
                                        ?>
									<script>
